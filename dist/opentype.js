...
(function (global, factory) {
  ...
  function makePostTable(postTable) {
      ...
      var isFixedPitch = ref.isFixedPitch; if ( isFixedPitch === void 0 ) isFixedPitch = 0;
      var minMemType42 = ref.minMemType42; if ( minMemType42 === void 0 ) minMemType42 = 0;
      var maxMemType42 = ref.maxMemType42; if ( maxMemType42 === void 0 ) maxMemType42 = 0;
  ...
  function fontToSfntTable(font) {
      ...
      var postTable = post.make(font.tables.post);
  ...
  function parseBuffer(buffer, opt) {
      ...
      for (var i = 0; i < numTables; i += 1) {
          ...
          switch (tableEntry.tag) {
              ...
              case "vhea":
                  table = uncompressTable(data, tableEntry);
                  vheaTableEntry = vhea.parse(table.data, table.offset);
                  break;
              case "vmtx":
